 ...
 */
export const DNF_PER_RACE = 0.05;
...
// Штраф мокрої траси для НЕПРАВИЛЬНОЇ гуми; правильна платить лише частку
// (див. wetPenalty у lapModel). Кросовер мусить сходитись: у легкий дощ інтер
// швидший за слік, у зливу дощова швидша за інтер, а слік не їде взагалі.
// До цього калібрування було навпаки — слік вигравав у інтера 1.5 с/коло під
// дощем, «правильна» реакція була пасткою, і саме об це розбивались виміри G1.
