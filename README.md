...
npm test                         # 104 тести моделі, балансу, сезону й гейм-дизайну
npm run e2e                      # 18 E2E-сценаріїв у справжньому Chromium
...
tests/       104 тести: детермінізм, модель кола, баланс по кожній трасі,
             стратегії, гейм-дизайн, повний сезон
e2e/         18 сценаріїв Playwright у справжньому Chromium
```
